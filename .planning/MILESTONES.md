...
- **Phase 4 — Polish / compliance:** `/what-is-a-bip` + `/privacy` static pages, GDPR Art-17 account erasure (SECURITY DEFINER RPC), repo health (CONTRIBUTING + proprietary LICENSE + Contributor Covenant + gitleaks CI), static OG cards, Suspense/perf hardening, Playwright E2E (4 golden-path specs).
