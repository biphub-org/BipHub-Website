...
- Plan 04-04: CONTRIBUTING.md adopts the locked 8-section structure (D-25) with code conventions checklist mirroring CLAUDE.md never-do items; CODE_OF_CONDUCT.md is Contributor Covenant v2.1 verbatim (D-26) with `[INSERT CONTACT METHOD]` replaced by `biphub.org@gmail.com`.
