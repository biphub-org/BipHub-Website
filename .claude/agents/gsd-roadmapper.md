...
Reference full template: `C:/dev/Antigravity/BipHub/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/dev/Antigravity/BipHub/.claude/get-shit-done/templates/state.md`.
