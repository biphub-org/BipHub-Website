...
Use template from `C:/dev/Antigravity/BipHub/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/dev/Antigravity/BipHub/.claude/get-shit-done/templates/UI-SPEC.md`
