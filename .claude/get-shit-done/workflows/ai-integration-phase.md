...
```markdown
Read C:/dev/Antigravity/BipHub/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/dev/Antigravity/BipHub/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/dev/Antigravity/BipHub/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/dev/Antigravity/BipHub/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/dev/Antigravity/BipHub/.claude/agents/gsd-eval-planner.md for instructions.
