...
```
Agent(
  prompt="Read C:/dev/Antigravity/BipHub/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/dev/Antigravity/BipHub/.claude/get-shit-done/templates/SECURITY.md`
