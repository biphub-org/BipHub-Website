...
--
-- RESTORED 2026-09-03: local dev + CI need this catalog (zero approved BIPs
-- breaks the e2e suite). NEVER apply to production.
-- =============================================================================
...
-- Fields (subject_area = isced_f_code = BipHub field id): it-engineering×5,
--   architecture×3, business-economics×3, social-sciences×3, health-sciences×2,
--   arts-design×1, communication×1, law×1, medicine×1
--   (dentistry / sports / education intentionally 0 — no fitting synthetic BIP)
...
seeded_bips as (
  ...
  values
    ...
    (
      ...
      'before',
      4, 'Four 2-hour synchronous sessions delivered weekly before arrival, recorded for asynchronous catch-up.',
    ...
    (
      ...
      'before',
      3, 'Three live 90-minute seminars plus asynchronous international reading groups.',
    ...
    (
      ...
      'before',
      2, 'Two preparatory webinars (3 hours total), recorded for asynchronous catch-up.',
    ...
    (
      ...
      'before',
      2, 'Two 90-minute preparatory sessions delivered via video conference.',
    ...
    (
      ...
      'before',
      2, 'Two live seminars plus a self-paced pre-visit analysis task.',
    ...
    (
      ...
      'before',
      2, 'Two live sessions with recorded playback available for asynchronous learners.',
