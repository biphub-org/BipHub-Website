...
--
-- RESTORED 2026-09-03: the suite needs these fixtures and CI was red without
-- them. NEVER apply to production — CI boots an ephemeral local Supabase per
-- run, which is the only sanctioned target for this file.
--
